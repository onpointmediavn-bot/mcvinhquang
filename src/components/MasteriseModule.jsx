...
export default function MasteriseModule() {
  const [selectedImg, setSelectedImg] = useState(null);
  const images = siteConfig.masteriseModule.images || [];
  ...
  return (
    <section id="masterise-module" className="relative min-h-screen w-full bg-graphite flex flex-col justify-center py-20 px-6 md:px-12 border-b border-charcoal overflow-hidden blueprint-grid-fine">
        ...
        <div className="relative p-6 md:p-8 border border-charcoal/80 bg-charcoal/20 backdrop-blur-md rounded-sm gold-glow w-full overflow-hidden">
          ...
          <div className="flex justify-between items-center border-b border-charcoal/60 pb-3 mb-6 font-mono text-[9px] text-platinum/50">
            <span className="flex items-center gap-2">
              ...
              TACTICAL_GRID // MASTERISE_EVENT_MONITOR
            </span>
          ...
          <svg className="absolute inset-0 w-full h-full pointer-events-none stroke-gold/10 fill-none" xmlns="http://www.w3.org/2000/svg">
            {/* Grid connecting lines matching the 3-column layout */}
            <line x1="33.3%" y1="0%" x2="33.3%" y2="100%" strokeDasharray="3,4" className="hidden lg:block" />
            <line x1="66.6%" y1="0%" x2="66.6%" y2="100%" strokeDasharray="3,4" className="hidden lg:block" />
            ...
            <circle cx="33.3%" cy="50%" r="3.5" fill="#D5B67A" className="animate-ping hidden lg:block" />
            <circle cx="33.3%" cy="50%" r="2" fill="#D5B67A" className="hidden lg:block" />
            <circle cx="66.6%" cy="50%" r="3.5" fill="#D5B67A" className="animate-ping hidden lg:block" />
            <circle cx="66.6%" cy="50%" r="2" fill="#D5B67A" className="hidden lg:block" />
          </svg>
          ...
          >
            {images.map((img, idx) => {
              ...
              const gridClasses = "lg:col-span-4 aspect-[4/3] lg:aspect-auto lg:h-[320px]";
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-0 z-0">
                    <img 
                      src={`/${img}`} 
                      alt={`${siteConfig.masteriseModule.title} ${idx + 1}`}
          ...
          <div className="flex justify-between items-center border-t border-charcoal/60 pt-3 mt-6 font-mono text-[8px] text-platinum/40">
            <span>SYS_COORD: MS_SYS_LINK // 100% STABLE</span>
        ...
        {selectedImg !== null && (
          ...
          >
            ...
            <div className="w-full border-t border-charcoal/80 pt-4 font-mono text-[9px] text-platinum/40 flex justify-between items-center z-10">
              <span>SCAN_NODE: CAM_MS_0{selectedImg + 1} // BUFFER: 100% // RESOLUTION: HIGH_RES</span>
