...
export default function CustomModule() {
  ...
  return (
    <section id="custom-module" className="relative min-h-screen w-full bg-graphite flex flex-col justify-center py-20 px-6 md:px-12 border-b border-charcoal overflow-hidden blueprint-grid-fine">
