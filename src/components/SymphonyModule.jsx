...
export default function SymphonyModule() {
  const [selectedImg, setSelectedImg] = useState(null);
  const images = siteConfig.symphonyModule.images || [];
      ...
      >
        ...
        <div className="hidden md:flex p-3 border-b border-charcoal/80 bg-obsidian/60 justify-between items-center font-mono text-[8px] z-10 opacity-50 group-hover:opacity-100 transition-opacity">
          <span className="text-gold font-bold flex items-center gap-1 uppercase">
            <Terminal size={8} /> LINK_SP_0{idx + 1}
          </span>
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src={`/${img}`} 
            alt={`${siteConfig.symphonyModule.title} ${idx + 1}`}
  ...
  return (
    <section id="symphony-module" className="relative md:min-h-screen w-full bg-graphite flex flex-col justify-center py-12 md:py-20 px-2 md:px-12 border-b border-charcoal overflow-hidden blueprint-grid-fine">
        ...
        <div className="relative px-0 py-4 md:p-8 border-x-0 border-y border-charcoal/80 md:border bg-charcoal/10 md:bg-charcoal/20 backdrop-blur-md rounded-none md:rounded-sm gold-glow w-full overflow-hidden">
          ...
          <div className="flex justify-between items-center border-b border-charcoal/60 pb-3 mb-6 font-mono text-[9px] text-platinum/50">
            <span className="flex items-center gap-2">
              ...
              TACTICAL_GRID // SYMPHONY_EVENT_MONITOR
            </span>
          ...
          <div className="flex justify-between items-center border-t border-charcoal/60 pt-3 mt-6 font-mono text-[8px] text-platinum/40">
            <span>SYS_COORD: SP_SYS_LINK // 100% STABLE</span>
          ...
          >
            ...
            <div className="relative flex-grow w-full flex items-center justify-center my-4 z-10">
                <motion.img 
                  ...
                  alt={`${siteConfig.symphonyModule.title} Lightbox ${selectedImg + 1}`}
                  drag="x"
            ...
            <div className="w-full border-t border-charcoal/80 pt-4 font-mono text-[9px] text-platinum/40 flex justify-between items-center z-10">
              <span>SCAN_NODE: CAM_SP_0{selectedImg + 1} // BUFFER: 100% // RESOLUTION: HIGH_RES</span>
